...
blazeface_path = os.path.join('D:\\majorProject\\DeepFake1\\deepfakeApp\\CViT-main\\helpers', 'blazeface.pth')
...
def prediction(): 
    ...
    facedet.load_anchors(os.path.join('D:\\majorProject\\DeepFake1\\deepfakeApp\\CViT-main\\helpers', 'anchors.npy'))
    ...
    tresh=50
    sample=os.path.join('D:\majorProject\DeepFake1\deepfakeApp\CViT-main\sample__prediction_data')
    ...
    checkpoint = torch.load('D:\majorProject\DeepFake1\deepfakeApp\CViT-main\weight\deepfake_cvit_gpu_inference_ep_50.pth', map_location=torch.device('cpu'))
    ...
    def re_pre(filenames, predictions):
        j=0
    ...
    a=re_pre(filenames, predictions)
